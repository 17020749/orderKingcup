...
import { escapeHtml } from 'file://C:/Users/HieuNT/Desktop/orderKingcup/node_modules/@vue/shared/dist/shared.cjs.js';
import { createRenderer, getRequestDependencies, getPreloadLinks, getPrefetchLinks } from 'file://C:/Users/HieuNT/Desktop/orderKingcup/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery, withTrailingSlash, decodePath, withLeadingSlash, withoutTrailingSlash, joinRelativeURL } from 'file://C:/Users/HieuNT/Desktop/orderKingcup/node_modules/ufo/dist/index.mjs';
import { renderToString } from 'file://C:/Users/HieuNT/Desktop/orderKingcup/node_modules/vue/server-renderer/index.mjs';
...
import destr, { destr as destr$1 } from 'file://C:/Users/HieuNT/Desktop/orderKingcup/node_modules/destr/dist/index.mjs';
import { snakeCase } from 'file://C:/Users/HieuNT/Desktop/orderKingcup/node_modules/scule/dist/index.mjs';
import { createHead as createHead$1, propsToString, renderSSRHead } from 'file://C:/Users/HieuNT/Desktop/orderKingcup/node_modules/unhead/dist/server.mjs';
import { stringify, uneval } from 'file://C:/Users/HieuNT/Desktop/orderKingcup/node_modules/devalue/index.js';
import { isVNode, isRef, toValue } from 'file://C:/Users/HieuNT/Desktop/orderKingcup/node_modules/vue/index.mjs';
import { DeprecationsPlugin, PromisesPlugin, TemplateParamsPlugin, AliasSortingPlugin } from 'file://C:/Users/HieuNT/Desktop/orderKingcup/node_modules/unhead/dist/plugins.mjs';
...
import consola, { consola as consola$1 } from 'file://C:/Users/HieuNT/Desktop/orderKingcup/node_modules/consola/dist/index.mjs';
import { ErrorParser } from 'file://C:/Users/HieuNT/Desktop/orderKingcup/node_modules/youch-core/build/index.js';
import { Youch } from 'file://C:/Users/HieuNT/Desktop/orderKingcup/node_modules/youch/build/index.js';
import { SourceMapConsumer } from 'file://C:/Users/HieuNT/Desktop/orderKingcup/node_modules/source-map/source-map.js';
import { AsyncLocalStorage } from 'node:async_hooks';
import { getContext } from 'file://C:/Users/HieuNT/Desktop/orderKingcup/node_modules/unctx/dist/index.mjs';
import { captureRawStackTrace, parseRawStackTrace } from 'file://C:/Users/HieuNT/Desktop/orderKingcup/node_modules/errx/dist/index.js';
import _wH6JrtIxmaSoA8lCPWFnE9z4lQeXW6H5z3l5aymEQw from 'file://C:/Users/HieuNT/Desktop/orderKingcup/node_modules/@nuxt/vite-builder/dist/fix-stacktrace.mjs';
import { promises } from 'node:fs';
import { fileURLToPath } from 'node:url';
import { dirname as dirname$1, resolve as resolve$1 } from 'file://C:/Users/HieuNT/Desktop/orderKingcup/node_modules/pathe/dist/index.mjs';
import { walkResolver } from 'file://C:/Users/HieuNT/Desktop/orderKingcup/node_modules/unhead/dist/utils.mjs';
...
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"C:/Users/HieuNT/Desktop/orderKingcup/.data/kv"}));
...
const _ge6DSFFDeXmNKJubyRnukX6Octulty_x0BNnYUYheh0 = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
    htmlContext.head.push(`<script>${script}<\/script>`);
  });
});

const rootDir = "C:/Users/HieuNT/Desktop/orderKingcup";
...
const _XwziJaz1kviNaRhHKZXHBw8wpsuidqb2ydiynbp2TTk = (nitroApp) => {
...
const plugins = [
  _ge6DSFFDeXmNKJubyRnukX6Octulty_x0BNnYUYheh0,
_XwziJaz1kviNaRhHKZXHBw8wpsuidqb2ydiynbp2TTk,
...
// @ts-expect-error file will be produced after app build
const getClientManifest = () => import('file://C:/Users/HieuNT/Desktop/orderKingcup/.nuxt//dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
// -- SSR Renderer --
...
const _lazy_gxdUeu = () => Promise.resolve().then(function () { return renderer; });

const handlers = [
  { route: '', handler: _ugevGS, lazy: false, middleware: true, method: undefined },
  { route: '/__nuxt_error', handler: _lazy_gxdUeu, lazy: true, middleware: false, method: undefined },
