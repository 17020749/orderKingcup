...
function transport(id = 'bus-1', overrides = {}) {
  return {
    ...
    carrier_district_codes: [719, 740],
    carrier_district_names: ['Huyện Bàu Bàng', 'Huyện Long Thành'],
    selected_province_codes: [75, 79],
    selected_province_names: ['Tỉnh Đồng Nai', 'Thành phố Hồ Chí Minh'],
    selected_district_codes: [740],
    selected_district_names: ['Huyện Long Thành'],
...
test('bus_transport.edit sửa snapshot nhà xe nhưng không đổi liên kết yêu cầu', async () => {
  ...
  await assertSucceeds(updateDoc(doc(db, 'bus_transport_orders', 'bus-1'), {
    ...
    carrier_district_codes: [740, 760, 803],
    carrier_district_names: ['Huyện Long Thành', 'Quận 1', 'Huyện Bến Lức'],
    selected_province_codes: [79, 80],
    selected_province_names: ['Thành phố Hồ Chí Minh', 'Tỉnh Long An'],
    selected_district_codes: [760, 803],
    selected_district_names: ['Quận 1', 'Huyện Bến Lức'],
